...
# File parsing
path <- "/Users/mckinleynevins/Dropbox/WSU/Mycorrhizae_Project/Community_Analyses/Data/240223_Nevins_AMF_demultiplxed_fastqs/" # CHANGE to the subdirectory containing your demultiplexed fastq files
...
FWD <- "TTGGAGGGCAAGTCTGGTGCC" # Sequence of FWD primer
REV <- "GAACCCAAACACTTTGGTTTCC"  # Sequence of REV primer
######################################################################################################
...
#there are some hits on the reverse compliment - 308 for FWD.ReverseReads and 267 for REV.ForwardReads
